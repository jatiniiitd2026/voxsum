export function Spin2WinWheel() {
    var xmlns = "http://www.w3.org/2000/svg",
        ...
        spinVelocityTracker,
        gameResultsArray = [],
        pegSnd = new Audio('assets/spin-win/media/wheel_tick.mp3'),
                ...
                if (segmentValuesArray[i].type == "image") {
                    ...
                    lines.forEach(function (value, index) {
                        ...
                        arr.forEach((value, index) => {
                            ...
                            ts.style.fill = segmentValuesArray[i].textColor;

                            ts.setAttributeNS(null, 'dy', (lineIndex) ? "1.2em" : 0);

                            ts.setAttributeNS(null, 'x', centerX);
                            ts.setAttributeNS(null, 'dy', (index * 50).toString());
        ...
        showResult = function (e) {
            ...
            if (!isNaN(e)) {
                ...
                resultObj = {
                    ...
                    msg: segmentValuesArray[e].value,
                    gameId: gameId,
                    userData: segmentValuesArray[e].userData
                };
                //fire the result event
                onResult.call(e.callee, resultObj);
    ...
    this.init = function (e) {
        ...
        onResult = (e.onResult) ? e.onResult.bind(e.callee) : function () {
            console.log(e, 'hi')
        };
    ...
    this.start = function (degree) {
        let rangeForEachWidth = 360 / numSegments;
        let decider = Math.floor(((degree / rangeForEachWidth) % numSegments));
        let start = getTrigger();
        probabilityArray = Array(100).fill(decider);
        start()
    };
